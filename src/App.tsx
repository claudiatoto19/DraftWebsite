      ...
      <main className="max-w-5xl mx-auto px-6 pt-24">
        ...
        <section id="about" className="py-20 border-b border-[#E8EDF2]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
            ...
            <div>
              {/* Photo placeholder */}
              <div className="w-full aspect-[4/5] bg-[#D4E3F0] rounded-2xl mb-8 overflow-hidden flex items-end justify-center">
                <div className="w-32 h-40 bg-[#4A6A8A] rounded-t-full opacity-30" />
              </div>
